...
algorithm
  simEqOut := matchcontinue(simEqIn,assIn)
    local
  Boolean partOfMixed;
  Integer newIdx, oldIdx, indexNonLinearSystem, indexLinearSystem, nUnknowns, adolcIndex;
  array<Integer> ass;
  ...
  BackendDAE.EquationAttributes eqAttr;
    case(SimCode.SES_NONLINEAR(SimCode.NONLINEARSYSTEM(eqs=eqs,crefs=crefs,indexNonLinearSystem=indexNonLinearSystem,nUnknowns=nUnknowns,jacobianMatrix=jacobianMatrix,homotopySupport=homotopySupport,mixedSystem=mixedSystem, tornSystem=tornSystem, adolcIndex=adolcIndex), eqAttr=eqAttr),_)
      equation
        ...
        simEqSys = SimCode.SES_NONLINEAR(SimCode.NONLINEARSYSTEM(newIdx,eqs,crefs,indexNonLinearSystem,nUnknowns,jacobianMatrix,homotopySupport,mixedSystem,tornSystem,adolcIndex), NONE(), eqAttr);
   then simEqSys;
    case(SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(partOfMixed=partOfMixed,tornSystem=tornSystem,vars=vars,beqs=beqs,simJac=simJac,residual=eqs,jacobianMatrix=jacobianMatrix,sources=sources,indexLinearSystem=indexLinearSystem,nUnknowns=nUnknowns,adolcIndex=adolcIndex), eqAttr=eqAttr),ass)
      equation
        ...
        simEqSys = SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(newIdx,partOfMixed,tornSystem,vars,beqs,simJac,eqs,jacobianMatrix,sources,indexLinearSystem,nUnknowns,adolcIndex), NONE(), eqAttr);
   then simEqSys;
    case(_,ass)
      equation
        oldIdx = SimCodeUtil.simEqSystemIndex(simEqIn);
...
algorithm
  (simEqOut,tplOut) := matchcontinue(simEqIn,tplIn)
    local
  Boolean partOfMixed;
  Integer newIdx, oldIdx, indexNonLinearSystem, indexLinearSystem, indexMixedSystem, nUnknowns, adolcIndex;
  array<Integer> ass;
  ...
  Boolean mixedSystem, tornSystem;
  BackendDAE.EquationAttributes eqAttr;
    case(SimCode.SES_NONLINEAR(SimCode.NONLINEARSYSTEM(index=oldIdx,eqs=eqs,crefs=crefs,indexNonLinearSystem=indexNonLinearSystem,nUnknowns=nUnknowns,jacobianMatrix=jacobianMatrix,homotopySupport=homotopySupport,mixedSystem=mixedSystem,tornSystem=tornSystem,adolcIndex=adolcIndex), _, eqAttr=eqAttr),(newIdx,ass))
      equation
   ...
   then (simEqSys,(newIdx+1,ass));
    case(SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(index=oldIdx,partOfMixed=partOfMixed,tornSystem=tornSystem,vars=vars,beqs=beqs,simJac=simJac,residual=eqs,jacobianMatrix=jacobianMatrix,sources=sources,indexLinearSystem=indexLinearSystem,nUnknowns=nUnknowns, adolcIndex=adolcIndex), _, eqAttr=eqAttr),(newIdx,ass))
      equation
        ...
        simEqSys = SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(newIdx,partOfMixed,tornSystem,vars,beqs,simJac,eqs,jacobianMatrix,sources,indexLinearSystem,nUnknowns,adolcIndex), NONE(), eqAttr);
   then (simEqSys,(newIdx+1,ass));
    case(SimCode.SES_MIXED(index=oldIdx,cont=cont,discVars=discVars,discEqs=eqs,indexMixedSystem=indexMixedSystem, eqAttr=eqAttr),(newIdx,ass))
      equation
        (cont,(newIdx,ass)) = TDS_replaceSimEqSysIndexWithUpdate(cont,(newIdx,ass));
        (eqs,(newIdx,ass)) = List.mapFold(eqs,TDS_replaceSimEqSysIndexWithUpdate,(newIdx,ass));
        ass = arrayUpdate(ass,oldIdx,newIdx);
        simEqSys = SimCode.SES_MIXED(newIdx,cont,discVars,eqs,indexMixedSystem,eqAttr);
   then (simEqSys,(newIdx+1,ass));
    case(_,(newIdx,ass))
      equation
        oldIdx = SimCodeUtil.simEqSystemIndex(simEqIn);
...
algorithm
  (simEqsOut,simEqSysIdxOut) := matchcontinue(simEqsIn,simEqSysIdxIn,repl,simEqsFold)
    local
      Integer simEqSysIdx, index, numEqs, nUnknowns, adolcIndex;
      Boolean partOfMixed,tornSystem;
   ...
   case((simEqSys as SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(index=index,partOfMixed=partOfMixed,tornSystem=tornSystem,vars=vars,beqs=beqs,simJac=simJac,jacobianMatrix=jacobianMatrix, residual=residual,sources=sources,indexLinearSystem=indexLinearSystem,nUnknowns=nUnknowns,adolcIndex=adolcIndex), eqAttr=eqAttr))::rest,_,_,_)
     equation
       ...
       simEqSys = SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(index,partOfMixed,tornSystem,vars,beqs,simJac,duplicated,jacobianMatrix,sources,indexLinearSystem,nUnknowns,adolcIndex), NONE(), eqAttr);
...
algorithm
  (simEqSysOut,idcsOut) := match(simEqSysIn,idcsIn)
    local
      Boolean pom;
      Integer idx,lsIdx,nlsIdx,mIdx,nUnknowns,adolcIndex;
      SimCode.SimEqSystem simEqSys,cont;
      list<SimCodeVar.SimVar> simVars;
      ...
      Boolean mixedSystem,tornSystem;
      BackendDAE.EquationAttributes eqAttr;
    case(SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(index=idx,partOfMixed=pom,tornSystem=tornSystem,vars=simVars,beqs=expLst,sources=sources,simJac=simJac,residual=simEqSysLst,jacobianMatrix=jac,nUnknowns=nUnknowns,adolcIndex=adolcIndex), eqAttr=eqAttr),_)
      equation
    ...
    case(SimCode.SES_NONLINEAR(SimCode.NONLINEARSYSTEM(index=idx,eqs=simEqSysLst,crefs=crefs,nUnknowns=nUnknowns,jacobianMatrix=jac,homotopySupport=homotopySupport,mixedSystem=mixedSystem,tornSystem=tornSystem, adolcIndex=adolcIndex), eqAttr=eqAttr),_)
      equation
        (lsIdx,nlsIdx,mIdx) = idcsIn;
        simEqSys = SimCode.SES_NONLINEAR(SimCode.NONLINEARSYSTEM(idx,simEqSysLst,crefs,nlsIdx,nUnknowns,jac,homotopySupport,mixedSystem,tornSystem,adolcIndex), NONE(), eqAttr);
    ...
    case(SimCode.SES_MIXED(index=idx,cont=cont,discVars=simVars,discEqs=simEqSysLst, eqAttr=eqAttr),_)
      equation
        (lsIdx,nlsIdx,mIdx) = idcsIn;
        simEqSys = SimCode.SES_MIXED(idx,cont,simVars,simEqSysLst,mIdx, eqAttr);
...
algorithm
    ...
    local
      ...
      Integer idx,idxLS,idxNLS,idxMS,nUnknowns,adolcIndex;
      list<Boolean> bLst;
      ...
      BackendDAE.EquationAttributes eqAttr;
    case(SimCode.SES_RESIDUAL(index=idx,exp=exp,source=source,eqAttr=eqAttr),_)
      equation
    ...
    case(SimCode.SES_SIMPLE_ASSIGN(index=idx,cref=cref,exp=exp,source=source,eqAttr=eqAttr),_)
      equation
    ...
    case(SimCode.SES_SIMPLE_ASSIGN_CONSTRAINTS(index=idx,cref=cref,exp=exp,source=source,cons=cons,eqAttr=eqAttr),_)
      equation
        hasRepl = BackendVarTransform.hasReplacement(replIn,cref);
        DAE.CREF(componentRef=cref) = if hasRepl then BackendVarTransform.getReplacement(replIn,cref) else DAE.CREF(cref,DAE.T_UNKNOWN_DEFAULT);
        (exp,changed) = BackendVarTransform.replaceExp(exp,replIn,NONE());
    ...
    then (simEqSys,changed or hasRepl);
    case(SimCode.SES_ARRAY_CALL_ASSIGN(index=idx,lhs=lhs,exp=exp,source=source,eqAttr=eqAttr),_)
      equation
    ...
    then (simEqSys,changed or hasRepl);
    case(SimCode.SES_IFEQUATION(index=idx,ifbranches=ifs,elsebranch=elsebranch,source=source,eqAttr=eqAttr),_)
      equation
        ...
        simEqSys = SimCode.SES_IFEQUATION(idx,ifs,elsebranch,source,eqAttr);
    then (simEqSys,changed);
    case(SimCode.SES_ALGORITHM(index=idx,statements=stmts,eqAttr=eqAttr),_)
      equation
    ...
    then (simEqSys,changed);
    case(SimCode.SES_LINEAR(SimCode.LINEARSYSTEM(index=idx,partOfMixed=pom,tornSystem=tornSystem,vars=simVars,beqs=expLst,sources=sources,simJac=simJac,residual=simEqSysLst,jacobianMatrix=jac,indexLinearSystem=idxLS,nUnknowns=nUnknowns,adolcIndex=adolcIndex),eqAttr=eqAttr),_)
      equation
    ...
    then (simEqSys,changed);
    case(SimCode.SES_NONLINEAR(SimCode.NONLINEARSYSTEM(index=idx,eqs=simEqSysLst,crefs=crefs,indexNonLinearSystem=idxNLS,nUnknowns=nUnknowns,homotopySupport=homotopySupport,mixedSystem=mixedSystem,tornSystem=tornSystem,adolcIndex=adolcIndex),eqAttr=eqAttr),_)
      equation
        ...
        simEqSys = SimCode.SES_NONLINEAR(SimCode.NONLINEARSYSTEM(idx,simEqSysLst,crefs,idxNLS,nUnknowns,NONE(),homotopySupport,mixedSystem,tornSystem,adolcIndex), NONE(), eqAttr);
    then (simEqSys,changed);
    case(SimCode.SES_MIXED(index=idx,cont=simEqSys,discVars=simVars,discEqs=simEqSysLst,indexMixedSystem=idxMS,eqAttr=eqAttr),_)
      equation
        ...
        (simEqSysLst,bLst) = List.map1_2(simEqSysLst,replaceExpsInSimEqSystem,replIn);
        changed = List.fold(bLst,boolOr,changed);
        simEqSys = SimCode.SES_MIXED(idx,simEqSys,simVars,simEqSysLst,idxMS,eqAttr);
    then (simEqSys,changed);
    case(SimCode.SES_WHEN(index=idx,conditions=crefs,initialCall=ic,whenStmtLst={BackendDAE.ASSIGN(left=lhs,right=exp)},elseWhen=NONE(),source=source,eqAttr=eqAttr),_)
      equation
        ...
        simEqSys = SimCode.SES_WHEN(idx,crefs,ic,{BackendDAE.ASSIGN(lhs, exp, source)},NONE(),source, eqAttr);
    then (simEqSys,changed);
    case(SimCode.SES_WHEN(index=idx,conditions=crefs,initialCall=ic,whenStmtLst={BackendDAE.ASSIGN(left=lhs,right=exp)},elseWhen=SOME(simEqSys),source=source,eqAttr=eqAttr),_)
      equation
        (crefExps,bLst) = List.map1_2(crefs,BackendVarTransform.replaceCref,replIn);
        crefs = List.map(crefExps,Expression.expCref);
        (lhs,changed) = BackendVarTransform.replaceExp(lhs,replIn, NONE());
        ...
        changed = boolOr(changed,changed1);
        simEqSys = SimCode.SES_WHEN(idx,crefs,ic,{BackendDAE.ASSIGN(lhs, exp, source)},SOME(simEqSys),source, eqAttr);
    then (simEqSys,changed);
  else
    equation
