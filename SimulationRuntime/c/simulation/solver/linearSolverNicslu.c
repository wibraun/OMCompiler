...
{
	/*Datenstruktur f�r NICSLU erzeugen*/
	...
	/*Speicher f�r SNicsLU reservieren*/
	...
	/*Ben�tigte Werte f�r weiteren Verlauf*/
...
//Hier keine Ver�nderung vorgenommen
static
...
//Ausgabe von Matrix; vorl�ufig auskommentiert
